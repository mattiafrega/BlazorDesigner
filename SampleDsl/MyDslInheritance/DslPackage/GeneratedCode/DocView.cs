...
namespace Company.MyDslInheritance
{
	...
	/// </summary>
	internal partial class MyDslInheritanceDocView : MyDslInheritanceDocViewBase
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceDocView.
		/// </summary>
		public MyDslInheritanceDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDslInheritanceDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceDocView.
		/// </summary>
		protected MyDslInheritanceDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MyDslInheritanceDocDataBase docData = this.DocData as MyDslInheritanceDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MyDslInheritanceDocViewBase should be an MyDslInheritanceDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.MyDslInheritance.MyDslInheritanceDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.MyDslInheritance.MyDslInheritanceDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslInheritance.MyDslInheritanceToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.MyDslInheritance.MyDslInheritanceToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MyDslInheritanceDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.MyDslInheritance.MyDslInheritanceHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.MyDslInheritance.MyDslInheritanceHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.MyDslInheritance.MyDslInheritanceHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
