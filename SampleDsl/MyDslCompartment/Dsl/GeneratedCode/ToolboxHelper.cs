...
namespace Company.MyDslCompartment
{
	...
	/// </remarks>
	public partial class MyDslCompartmentToolboxHelper : MyDslCompartmentToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslCompartmentToolboxHelper.
		/// </summary>
		public MyDslCompartmentToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslCompartmentToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslCompartment toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslCompartment.1.0";
		...
		/// <summary>
		/// Constructs a new MyDslCompartmentToolboxHelperBase.
		/// </summary>
		protected MyDslCompartmentToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslCompartment.MyDslCompartmentDomainModel.SingletonResourceManager.GetString("MyDslCompartmentToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.MyDslCompartment.MyDslCompartmentDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.MyDslCompartment.ScaffaleToolboxItem":
					// Add Scaffale shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslCompartment.ScaffaleToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("ScaffaleToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("ScaffaleToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslCompartment.MyDslCompartmentToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslCompartmentToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"Scaffale", // F1 help keyword for the toolbox item.
						resourceManager.GetString("ScaffaleToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslCompartment.Scaffale.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslCompartment.LibroToolboxItem":
					// Add Libro shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslCompartment.LibroToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("LibroToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("LibroToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslCompartment.MyDslCompartmentToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslCompartmentToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"Libro", // F1 help keyword for the toolbox item.
						resourceManager.GetString("LibroToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslCompartment.Libro.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslCompartment.MyDslCompartmentDomainModel));
