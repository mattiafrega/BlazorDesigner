...
namespace Company.MyDslPorts
{
	...
	/// </summary>
	internal partial class MyDslPortsDocView : MyDslPortsDocViewBase
	{
		/// <summary>
		/// Constructs a new MyDslPortsDocView.
		/// </summary>
		public MyDslPortsDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDslPortsDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MyDslPortsDocView.
		/// </summary>
		protected MyDslPortsDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MyDslPortsDocDataBase docData = this.DocData as MyDslPortsDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MyDslPortsDocViewBase should be an MyDslPortsDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.MyDslPorts.MyDslPortsDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.MyDslPorts.MyDslPortsDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslPorts.MyDslPortsToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.MyDslPorts.MyDslPortsToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MyDslPortsDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.MyDslPorts.MyDslPortsHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.MyDslPorts.MyDslPortsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.MyDslPorts.MyDslPortsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
