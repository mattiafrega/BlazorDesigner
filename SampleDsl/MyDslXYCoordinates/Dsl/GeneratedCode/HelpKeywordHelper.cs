...
namespace Company.MyDslXYCoordinates
{
	...
	/// </remarks>
	public partial class MyDslXYCoordinatesHelpKeywordHelper : MyDslXYCoordinatesHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesHelpKeywordHelper.
		/// </summary>
		protected MyDslXYCoordinatesHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslXYCoordinatesHelpKeywordHelper.
		/// </summary>
		public static MyDslXYCoordinatesHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslXYCoordinatesHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesHelpKeywordHelperBase.
		/// </summary>
		protected MyDslXYCoordinatesHelpKeywordHelperBase()
			: base() { }
