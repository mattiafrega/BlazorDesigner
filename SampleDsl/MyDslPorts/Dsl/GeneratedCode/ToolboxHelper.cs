...
namespace Company.MyDslPorts
{
	...
	/// </remarks>
	public partial class MyDslPortsToolboxHelper : MyDslPortsToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslPortsToolboxHelper.
		/// </summary>
		public MyDslPortsToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslPortsToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslPorts toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslPorts.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new MyDslPortsToolboxHelperBase.
		/// </summary>
		protected MyDslPortsToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslPorts.MyDslPortsDomainModel.SingletonResourceManager.GetString("MyDslPortsToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.MyDslPorts.MyDslPortsDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.MyDslPorts.ComponentToolboxItem":
					// Add Component shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslPorts.ComponentToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.MyDslPorts.MyDslPortsToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslPortsToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.MyDslPorts.Component.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslPorts.InPortToolboxItem":
					// Add InPort shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslPorts.InPortToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::Company.MyDslPorts.InPort.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslPorts.OutPortToolboxItem":
					// Add OutPort shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslPorts.OutPortToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::Company.MyDslPorts.OutPort.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslPorts.ConnectionToolboxItem":

					// Add Connection connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslPorts.ConnectionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
					...
					break;
				case "Company.MyDslPorts.CommentToolboxItem":
					// Add Comment shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslPorts.CommentToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::Company.MyDslPorts.Comment.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslPorts.MyDslPortsDomainModel));
