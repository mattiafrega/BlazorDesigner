...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "Company.MyDslRelation.MyDslRelationDiagram")]

namespace Company.MyDslRelation
{
	/// <summary>
	/// DomainClass MyDslRelationDiagram
	/// Description for Company.MyDslRelation.MyDslRelationDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("Company.MyDslRelation.MyDslRelationDiagram.DisplayName", typeof(global::Company.MyDslRelation.MyDslRelationDomainModel), "Company.MyDslRelation.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("Company.MyDslRelation.MyDslRelationDiagram.Description", typeof(global::Company.MyDslRelation.MyDslRelationDomainModel), "Company.MyDslRelation.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::Company.MyDslRelation.MyDslRelationDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("760f69c8-1c57-4938-ada4-9362b24bbe6a")]
	public partial class MyDslRelationDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::Company.MyDslRelation.MyDslRelationToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::Company.MyDslRelation.MyButton)
			{
				global::Company.MyDslRelation.MyButtonShape newShape = new global::Company.MyDslRelation.MyButtonShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Company.MyDslRelation.MyButtonReferencesTargets)
			{
				global::Company.MyDslRelation.MyConnector newShape = new global::Company.MyDslRelation.MyConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::Company.MyDslRelation.MyButtonShape.DecoratorsInitialized += MyButtonShapeDecoratorMap.OnDecoratorsInitialized;
		}
		...
		internal static partial class MyButtonShapeDecoratorMap
		{
			...
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::Company.MyDslRelation.MyButton.NameDomainPropertyId);
		...
		private global::Company.MyDslRelation.MyConnectorConnectAction myConnectorConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::Company.MyDslRelation.MyDslRelationToolboxHelper.MyConnectorFilterString))
				{
					if (this.myConnectorConnectAction == null)
					{
						this.myConnectorConnectAction = new global::Company.MyDslRelation.MyConnectorConnectAction(this);
						this.myConnectorConnectAction.MouseActionDeactivated += new DslDiagrams::MouseAction.MouseActionDeactivatedEventHandler(OnConnectActionDeactivated);
					}
					action = this.myConnectorConnectAction;
				} 
				else
				{
					action = null;
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				if(disposing)
				{
					if(this.myConnectorConnectAction != null)
					{
						this.myConnectorConnectAction.Dispose();
						this.myConnectorConnectAction = null;
					}
				}
			}
			finally
		...
		/// <summary>
		/// MyDslRelationDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x760f69c8, 0x1c57, 0x4938, 0xad, 0xa4, 0x93, 0x62, 0xb2, 0x4b, 0xbe, 0x6a);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public MyDslRelationDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public MyDslRelationDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace Company.MyDslRelation
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Company.MyDslRelation.MyButton), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::Company.MyDslRelation.MyButtonReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::Company.MyDslRelation.MyButton)
				{
					parentElement = GetParentForMyButton((global::Company.MyDslRelation.MyButton)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::Company.MyDslRelation.ExampleModel GetParentForMyButton( global::Company.MyDslRelation.MyButton root )
			{
				// Segments 0 and 1
				global::Company.MyDslRelation.ExampleModel result = root.ExampleModel;
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::Company.MyDslRelation.MyDslRelationDiagram diagram = linkShape.Diagram as global::Company.MyDslRelation.MyDslRelationDiagram;
						if (diagram != null)
						{
