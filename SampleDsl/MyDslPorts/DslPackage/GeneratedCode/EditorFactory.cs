...
namespace Company.MyDslPorts
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.MyDslPortsEditorFactoryId)]
	internal partial class MyDslPortsEditorFactory : MyDslPortsEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new MyDslPortsEditorFactory.
		/// </summary>
		public MyDslPortsEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDslPortsEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected MyDslPortsEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new MyDslPortsDocData(this.ServiceProvider, typeof(MyDslPortsEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new MyDslPortsDocView(docData, this.ServiceProvider);
		}
	}
}
