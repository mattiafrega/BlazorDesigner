...
namespace Company.MyDSL
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.MyDSLEditorFactoryId)]
	internal partial class MyDSLEditorFactory : MyDSLEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new MyDSLEditorFactory.
		/// </summary>
		public MyDSLEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDSLEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected MyDSLEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new MyDSLDocData(this.ServiceProvider, typeof(MyDSLEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new MyDSLDocView(docData, this.ServiceProvider);
		}
	}
}
