...
namespace Company.MyDslSwimlane
{
	...
	/// </remarks>
	public partial class MyDslSwimlaneHelpKeywordHelper : MyDslSwimlaneHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslSwimlaneHelpKeywordHelper.
		/// </summary>
		protected MyDslSwimlaneHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslSwimlaneHelpKeywordHelper.
		/// </summary>
		public static MyDslSwimlaneHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslSwimlaneHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslSwimlaneHelpKeywordHelperBase.
		/// </summary>
		protected MyDslSwimlaneHelpKeywordHelperBase()
			: base() { }
