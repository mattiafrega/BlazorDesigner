...
namespace Company.MyDslModeling
{
	...
	/// </remarks>
	public partial class MyDslModelingHelpKeywordHelper : MyDslModelingHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslModelingHelpKeywordHelper.
		/// </summary>
		protected MyDslModelingHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslModelingHelpKeywordHelper.
		/// </summary>
		public static MyDslModelingHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslModelingHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslModelingHelpKeywordHelperBase.
		/// </summary>
		protected MyDslModelingHelpKeywordHelperBase()
			: base() { }
