...
namespace Company.MyDslInheritance
{
	...
	/// </remarks>
	public partial class MyDslInheritanceHelpKeywordHelper : MyDslInheritanceHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslInheritanceHelpKeywordHelper.
		/// </summary>
		protected MyDslInheritanceHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslInheritanceHelpKeywordHelper.
		/// </summary>
		public static MyDslInheritanceHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslInheritanceHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslInheritanceHelpKeywordHelperBase.
		/// </summary>
		protected MyDslInheritanceHelpKeywordHelperBase()
			: base() { }
