...
namespace Company.MyDslEmbeddingRelation
{
	...
	/// </summary>
	internal partial class MyDslEmbeddingRelationDocView : MyDslEmbeddingRelationDocViewBase
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationDocView.
		/// </summary>
		public MyDslEmbeddingRelationDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDslEmbeddingRelationDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationDocView.
		/// </summary>
		protected MyDslEmbeddingRelationDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MyDslEmbeddingRelationDocDataBase docData = this.DocData as MyDslEmbeddingRelationDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MyDslEmbeddingRelationDocViewBase should be an MyDslEmbeddingRelationDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MyDslEmbeddingRelationDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
