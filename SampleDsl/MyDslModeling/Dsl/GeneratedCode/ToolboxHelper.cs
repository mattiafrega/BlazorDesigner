...
namespace Company.MyDslModeling
{
	...
	/// </remarks>
	public partial class MyDslModelingToolboxHelper : MyDslModelingToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslModelingToolboxHelper.
		/// </summary>
		public MyDslModelingToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslModelingToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslModeling toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslModeling.1.0";
		...
		/// <summary>
		/// Constructs a new MyDslModelingToolboxHelperBase.
		/// </summary>
		protected MyDslModelingToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslModeling.MyDslModelingDomainModel.SingletonResourceManager.GetString("MyDslModelingToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "Company.MyDslModeling.MyObjectToolboxItem":
					// Add MyObject shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslModeling.MyObjectToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MyObjectToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MyObjectToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslModeling.MyDslModelingToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslModelingToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"CreateExampleClassF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MyObjectToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslModeling.MyObject.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslModeling.MySecondObjToolboxItem":
					// Add MySecondObj shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslModeling.MySecondObjToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MySecondObjToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MySecondObjToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslModeling.MyDslModelingToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslModelingToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"MySecondObj", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MySecondObjToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslModeling.MySecondObject.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslModeling.MyDslModelingDomainModel));
