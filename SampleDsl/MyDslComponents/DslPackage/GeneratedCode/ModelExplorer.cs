...
namespace Company.MyDslComponents
{
	...
	/// </summary>
	internal partial class MyDslComponentsExplorer : MyDslComponentsExplorerBase
	{
		/// <summary>
		/// Constructs a new MyDslComponentsExplorer.
		/// </summary>
		public MyDslComponentsExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the MyDslComponentsExplorerToolWindow.
	/// </summary>
	internal abstract class MyDslComponentsExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new MyDslComponentsExplorerBase.
		/// </summary>
		protected MyDslComponentsExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.MyDslComponentsExplorerMenu;
			}
		}
