...
namespace Company.MyDslEmbeddingRelation
{
	...
	/// </remarks>
	public partial class MyDslEmbeddingRelationToolboxHelper : MyDslEmbeddingRelationToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationToolboxHelper.
		/// </summary>
		public MyDslEmbeddingRelationToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslEmbeddingRelationToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslEmbeddingRelation toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslEmbeddingRelation.1.0";
		...
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationToolboxHelperBase.
		/// </summary>
		protected MyDslEmbeddingRelationToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.SingletonResourceManager.GetString("MyDslEmbeddingRelationToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.MyDslEmbeddingRelation.MyPanelToolboxItem":
					// Add MyPanel shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslEmbeddingRelation.MyPanelToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MyPanelToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MyPanelToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslEmbeddingRelationToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"MyPanel", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MyPanelToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslEmbeddingRelation.MyPanel.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslEmbeddingRelation.MyEmbeddedButtonToolboxItem":
					// Add MyEmbeddedButton shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslEmbeddingRelation.MyEmbeddedButtonToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MyEmbeddedButtonToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MyEmbeddedButtonToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslEmbeddingRelationToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"MyEmbeddedButton", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MyEmbeddedButtonToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslEmbeddingRelation.MyEmbeddedButton.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslEmbeddingRelation.MyNotEmbeddedButtonToolboxItem":
					// Add MyNotEmbeddedButton shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslEmbeddingRelation.MyNotEmbeddedButtonToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						3, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MyNotEmbeddedButtonToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MyNotEmbeddedButtonToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslEmbeddingRelationToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"MyNotEmbeddedButton", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MyNotEmbeddedButtonToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslEmbeddingRelation.MyNotEmbeddedButton.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel));
