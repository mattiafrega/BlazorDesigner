...
namespace Company.MyDSL
{
	...
	/// </summary>
	internal partial class MyDSLCommandSet : MyDSLCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDSLCommandSet.
		/// </summary>
		public MyDSLCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDSLCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDSLCommandSetBase.
		/// </summary>
		protected MyDSLCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDSLExplorerCommand,
				typeof(MyDSLEditorFactory).GUID);
		...
		{
			MyDSLExplorerToolWindow explorer = this.MyDSLExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDSLDocData CurrentMyDSLDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDSLDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDSLDocView CurrentMyDSLDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDSLDocView;
			}
		}
		...
		/// </summary>
		protected MyDSLExplorerToolWindow MyDSLExplorerToolWindow
		{
			get
			{
				MyDSLExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDSLExplorerToolWindow), true) as MyDSLExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDSLExplorerToolWindow explorerWindow = this.MyDSLExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDSLClipboardCommandSet : MyDSLClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDSLClipboardCommandSet.
		/// </summary>
		public MyDSLClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDSLClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDSLClipboardCommandSetBase.
		/// </summary>
		protected MyDSLClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
