...
namespace Company.MyDslSwimlane
{
	...
	/// </summary>
	internal partial class MyDslSwimlaneCommandSet : MyDslSwimlaneCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslSwimlaneCommandSet.
		/// </summary>
		public MyDslSwimlaneCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslSwimlaneCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslSwimlaneCommandSetBase.
		/// </summary>
		protected MyDslSwimlaneCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslSwimlaneExplorerCommand,
				typeof(MyDslSwimlaneEditorFactory).GUID);
		...
		{
			MyDslSwimlaneExplorerToolWindow explorer = this.MyDslSwimlaneExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslSwimlaneDocData CurrentMyDslSwimlaneDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslSwimlaneDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslSwimlaneDocView CurrentMyDslSwimlaneDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslSwimlaneDocView;
			}
		}
		...
		/// </summary>
		protected MyDslSwimlaneExplorerToolWindow MyDslSwimlaneExplorerToolWindow
		{
			get
			{
				MyDslSwimlaneExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslSwimlaneExplorerToolWindow), true) as MyDslSwimlaneExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslSwimlaneExplorerToolWindow explorerWindow = this.MyDslSwimlaneExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslSwimlaneClipboardCommandSet : MyDslSwimlaneClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslSwimlaneClipboardCommandSet.
		/// </summary>
		public MyDslSwimlaneClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslSwimlaneClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslSwimlaneClipboardCommandSetBase.
		/// </summary>
		protected MyDslSwimlaneClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
