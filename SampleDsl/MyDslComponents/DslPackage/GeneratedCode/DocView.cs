...
namespace Company.MyDslComponents
{
	...
	/// </summary>
	internal partial class MyDslComponentsDocView : MyDslComponentsDocViewBase
	{
		/// <summary>
		/// Constructs a new MyDslComponentsDocView.
		/// </summary>
		public MyDslComponentsDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDslComponentsDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MyDslComponentsDocView.
		/// </summary>
		protected MyDslComponentsDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MyDslComponentsDocDataBase docData = this.DocData as MyDslComponentsDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MyDslComponentsDocViewBase should be an MyDslComponentsDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.MyDslComponents.MyDslComponentsDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.MyDslComponents.MyDslComponentsDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslComponents.MyDslComponentsToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.MyDslComponents.MyDslComponentsToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MyDslComponentsDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.MyDslComponents.MyDslComponentsHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.MyDslComponents.MyDslComponentsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.MyDslComponents.MyDslComponentsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
