...
namespace Company.MyDslEmbeddingRelation
{
	...
	/// </remarks>
	public partial class MyDslEmbeddingRelationHelpKeywordHelper : MyDslEmbeddingRelationHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationHelpKeywordHelper.
		/// </summary>
		protected MyDslEmbeddingRelationHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslEmbeddingRelationHelpKeywordHelper.
		/// </summary>
		public static MyDslEmbeddingRelationHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslEmbeddingRelationHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationHelpKeywordHelperBase.
		/// </summary>
		protected MyDslEmbeddingRelationHelpKeywordHelperBase()
			: base() { }
