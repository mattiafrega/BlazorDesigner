...
namespace Company.MyDslCompartment
{
	...
	/// </summary>
	internal partial class MyDslCompartmentCommandSet : MyDslCompartmentCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslCompartmentCommandSet.
		/// </summary>
		public MyDslCompartmentCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslCompartmentCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslCompartmentCommandSetBase.
		/// </summary>
		protected MyDslCompartmentCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslCompartmentExplorerCommand,
				typeof(MyDslCompartmentEditorFactory).GUID);
		...
		{
			MyDslCompartmentExplorerToolWindow explorer = this.MyDslCompartmentExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslCompartmentDocData CurrentMyDslCompartmentDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslCompartmentDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslCompartmentDocView CurrentMyDslCompartmentDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslCompartmentDocView;
			}
		}
		...
		/// </summary>
		protected MyDslCompartmentExplorerToolWindow MyDslCompartmentExplorerToolWindow
		{
			get
			{
				MyDslCompartmentExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslCompartmentExplorerToolWindow), true) as MyDslCompartmentExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslCompartmentExplorerToolWindow explorerWindow = this.MyDslCompartmentExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslCompartmentClipboardCommandSet : MyDslCompartmentClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslCompartmentClipboardCommandSet.
		/// </summary>
		public MyDslCompartmentClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslCompartmentClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslCompartmentClipboardCommandSetBase.
		/// </summary>
		protected MyDslCompartmentClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
