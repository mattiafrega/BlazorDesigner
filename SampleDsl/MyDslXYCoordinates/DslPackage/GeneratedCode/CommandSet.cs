...
namespace Company.MyDslXYCoordinates
{
	...
	/// </summary>
	internal partial class MyDslXYCoordinatesCommandSet : MyDslXYCoordinatesCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesCommandSet.
		/// </summary>
		public MyDslXYCoordinatesCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslXYCoordinatesCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesCommandSetBase.
		/// </summary>
		protected MyDslXYCoordinatesCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslXYCoordinatesExplorerCommand,
				typeof(MyDslXYCoordinatesEditorFactory).GUID);
		...
		{
			MyDslXYCoordinatesExplorerToolWindow explorer = this.MyDslXYCoordinatesExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslXYCoordinatesDocData CurrentMyDslXYCoordinatesDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslXYCoordinatesDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslXYCoordinatesDocView CurrentMyDslXYCoordinatesDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslXYCoordinatesDocView;
			}
		}
		...
		/// </summary>
		protected MyDslXYCoordinatesExplorerToolWindow MyDslXYCoordinatesExplorerToolWindow
		{
			get
			{
				MyDslXYCoordinatesExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslXYCoordinatesExplorerToolWindow), true) as MyDslXYCoordinatesExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslXYCoordinatesExplorerToolWindow explorerWindow = this.MyDslXYCoordinatesExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslXYCoordinatesClipboardCommandSet : MyDslXYCoordinatesClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesClipboardCommandSet.
		/// </summary>
		public MyDslXYCoordinatesClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslXYCoordinatesClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesClipboardCommandSetBase.
		/// </summary>
		protected MyDslXYCoordinatesClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
