...
namespace Company.MyDslRelation
{
	...
	/// </summary>
	public static partial class MyButtonReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.MyDslRelation.MyButton)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.MyDslRelation.MyButton)
				{
					if (candidateTarget is global::Company.MyDslRelation.MyButton)
					{
						global::Company.MyDslRelation.MyButton sourceMyButton = (global::Company.MyDslRelation.MyButton)candidateSource;
						global::Company.MyDslRelation.MyButton targetMyButton = (global::Company.MyDslRelation.MyButton)candidateTarget;
						if(targetMyButton == null || sourceMyButton == null || global::Company.MyDslRelation.MyButtonReferencesTargets.GetLinks(sourceMyButton, targetMyButton).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.MyDslRelation.MyButton)
				{
					if (target is global::Company.MyDslRelation.MyButton)
					{
						global::Company.MyDslRelation.MyButton sourceAccepted = (global::Company.MyDslRelation.MyButton)source;
						global::Company.MyDslRelation.MyButton targetAccepted = (global::Company.MyDslRelation.MyButton)target;
						DslModeling::ElementLink result = new global::Company.MyDslRelation.MyButtonReferencesTargets(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class MyConnectorConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new MyConnectorConnectAction for the given Diagram.
		/// </summary>
		public MyConnectorConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the MyConnectorConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new MyConnectorConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class MyConnectorConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the MyConnectorConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected MyConnectorConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder MyButtonReferencesTargetsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return MyButtonReferencesTargetsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return MyButtonReferencesTargetsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				MyButtonReferencesTargetsBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class MyConnectorConnectionType : MyConnectorConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the MyConnectorConnectionType with the given ConnectionBuilder.
			/// </summary>
			public MyConnectorConnectionType() : base() {}
		}
	}
}
