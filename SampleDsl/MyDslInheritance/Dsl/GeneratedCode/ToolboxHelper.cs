...
namespace Company.MyDslInheritance
{
	...
	/// </remarks>
	public partial class MyDslInheritanceToolboxHelper : MyDslInheritanceToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceToolboxHelper.
		/// </summary>
		public MyDslInheritanceToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslInheritanceToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslInheritance toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslInheritance.1.0";
		...
		/// <summary>
		/// Constructs a new MyDslInheritanceToolboxHelperBase.
		/// </summary>
		protected MyDslInheritanceToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslInheritance.MyDslInheritanceDomainModel.SingletonResourceManager.GetString("MyDslInheritanceToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			switch(itemId)
			{
				case "Company.MyDslInheritance.DogToolboxItem":
					// Add Dog shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslInheritance.DogToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("DogToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("DogToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslInheritance.MyDslInheritanceToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslInheritanceToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"Dog", // F1 help keyword for the toolbox item.
						resourceManager.GetString("DogToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslInheritance.Dog.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslInheritance.CatToolboxItem":
					// Add Cat shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslInheritance.CatToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("CatToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("CatToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslInheritance.MyDslInheritanceToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslInheritanceToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"Cat", // F1 help keyword for the toolbox item.
						resourceManager.GetString("CatToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslInheritance.Cat.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslInheritance.MyDslInheritanceDomainModel));
