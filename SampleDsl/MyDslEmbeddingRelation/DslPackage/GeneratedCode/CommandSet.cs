...
namespace Company.MyDslEmbeddingRelation
{
	...
	/// </summary>
	internal partial class MyDslEmbeddingRelationCommandSet : MyDslEmbeddingRelationCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationCommandSet.
		/// </summary>
		public MyDslEmbeddingRelationCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslEmbeddingRelationCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationCommandSetBase.
		/// </summary>
		protected MyDslEmbeddingRelationCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslEmbeddingRelationExplorerCommand,
				typeof(MyDslEmbeddingRelationEditorFactory).GUID);
		...
		{
			MyDslEmbeddingRelationExplorerToolWindow explorer = this.MyDslEmbeddingRelationExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslEmbeddingRelationDocData CurrentMyDslEmbeddingRelationDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslEmbeddingRelationDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslEmbeddingRelationDocView CurrentMyDslEmbeddingRelationDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslEmbeddingRelationDocView;
			}
		}
		...
		/// </summary>
		protected MyDslEmbeddingRelationExplorerToolWindow MyDslEmbeddingRelationExplorerToolWindow
		{
			get
			{
				MyDslEmbeddingRelationExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslEmbeddingRelationExplorerToolWindow), true) as MyDslEmbeddingRelationExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslEmbeddingRelationExplorerToolWindow explorerWindow = this.MyDslEmbeddingRelationExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslEmbeddingRelationClipboardCommandSet : MyDslEmbeddingRelationClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationClipboardCommandSet.
		/// </summary>
		public MyDslEmbeddingRelationClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslEmbeddingRelationClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationClipboardCommandSetBase.
		/// </summary>
		protected MyDslEmbeddingRelationClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
