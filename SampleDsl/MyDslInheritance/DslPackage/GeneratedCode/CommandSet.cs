...
namespace Company.MyDslInheritance
{
	...
	/// </summary>
	internal partial class MyDslInheritanceCommandSet : MyDslInheritanceCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceCommandSet.
		/// </summary>
		public MyDslInheritanceCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslInheritanceCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceCommandSetBase.
		/// </summary>
		protected MyDslInheritanceCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslInheritanceExplorerCommand,
				typeof(MyDslInheritanceEditorFactory).GUID);
		...
		{
			MyDslInheritanceExplorerToolWindow explorer = this.MyDslInheritanceExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslInheritanceDocData CurrentMyDslInheritanceDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslInheritanceDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslInheritanceDocView CurrentMyDslInheritanceDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslInheritanceDocView;
			}
		}
		...
		/// </summary>
		protected MyDslInheritanceExplorerToolWindow MyDslInheritanceExplorerToolWindow
		{
			get
			{
				MyDslInheritanceExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslInheritanceExplorerToolWindow), true) as MyDslInheritanceExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslInheritanceExplorerToolWindow explorerWindow = this.MyDslInheritanceExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslInheritanceClipboardCommandSet : MyDslInheritanceClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceClipboardCommandSet.
		/// </summary>
		public MyDslInheritanceClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslInheritanceClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceClipboardCommandSetBase.
		/// </summary>
		protected MyDslInheritanceClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
