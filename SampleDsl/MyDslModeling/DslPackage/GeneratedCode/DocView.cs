...
namespace Company.MyDslModeling
{
	...
	/// </summary>
	internal partial class MyDslModelingDocView : MyDslModelingDocViewBase
	{
		/// <summary>
		/// Constructs a new MyDslModelingDocView.
		/// </summary>
		public MyDslModelingDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDslModelingDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MyDslModelingDocView.
		/// </summary>
		protected MyDslModelingDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MyDslModelingDocDataBase docData = this.DocData as MyDslModelingDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MyDslModelingDocViewBase should be an MyDslModelingDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.MyDslModeling.MyDslModelingDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.MyDslModeling.MyDslModelingDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslModeling.MyDslModelingToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.MyDslModeling.MyDslModelingToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MyDslModelingDiagramMenu;
			}
		}
			...
			if(global::Company.MyDslModeling.MyDslModelingHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.MyDslModeling.MyDslModelingHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
