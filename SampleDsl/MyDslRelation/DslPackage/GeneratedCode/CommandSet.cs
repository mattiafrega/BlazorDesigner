...
namespace Company.MyDslRelation
{
	...
	/// </summary>
	internal partial class MyDslRelationCommandSet : MyDslRelationCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslRelationCommandSet.
		/// </summary>
		public MyDslRelationCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslRelationCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslRelationCommandSetBase.
		/// </summary>
		protected MyDslRelationCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslRelationExplorerCommand,
				typeof(MyDslRelationEditorFactory).GUID);
		...
		{
			MyDslRelationExplorerToolWindow explorer = this.MyDslRelationExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslRelationDocData CurrentMyDslRelationDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslRelationDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslRelationDocView CurrentMyDslRelationDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslRelationDocView;
			}
		}
		...
		/// </summary>
		protected MyDslRelationExplorerToolWindow MyDslRelationExplorerToolWindow
		{
			get
			{
				MyDslRelationExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslRelationExplorerToolWindow), true) as MyDslRelationExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslRelationExplorerToolWindow explorerWindow = this.MyDslRelationExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslRelationClipboardCommandSet : MyDslRelationClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslRelationClipboardCommandSet.
		/// </summary>
		public MyDslRelationClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslRelationClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslRelationClipboardCommandSetBase.
		/// </summary>
		protected MyDslRelationClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
