...
namespace Company.MyDslModeling
{
	...
	/// </summary>
	internal partial class MyDslModelingCommandSet : MyDslModelingCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslModelingCommandSet.
		/// </summary>
		public MyDslModelingCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslModelingCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslModelingCommandSetBase.
		/// </summary>
		protected MyDslModelingCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslModelingExplorerCommand,
				typeof(MyDslModelingEditorFactory).GUID);
		...
		{
			MyDslModelingExplorerToolWindow explorer = this.MyDslModelingExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslModelingDocData CurrentMyDslModelingDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslModelingDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslModelingDocView CurrentMyDslModelingDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslModelingDocView;
			}
		}
		...
		/// </summary>
		protected MyDslModelingExplorerToolWindow MyDslModelingExplorerToolWindow
		{
			get
			{
				MyDslModelingExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslModelingExplorerToolWindow), true) as MyDslModelingExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslModelingExplorerToolWindow explorerWindow = this.MyDslModelingExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslModelingClipboardCommandSet : MyDslModelingClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslModelingClipboardCommandSet.
		/// </summary>
		public MyDslModelingClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslModelingClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslModelingClipboardCommandSetBase.
		/// </summary>
		protected MyDslModelingClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
