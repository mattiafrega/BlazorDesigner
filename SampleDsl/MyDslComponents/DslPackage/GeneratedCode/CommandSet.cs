...
namespace Company.MyDslComponents
{
	...
	/// </summary>
	internal partial class MyDslComponentsCommandSet : MyDslComponentsCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslComponentsCommandSet.
		/// </summary>
		public MyDslComponentsCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslComponentsCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslComponentsCommandSetBase.
		/// </summary>
		protected MyDslComponentsCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslComponentsExplorerCommand,
				typeof(MyDslComponentsEditorFactory).GUID);
		...
		{
			MyDslComponentsExplorerToolWindow explorer = this.MyDslComponentsExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslComponentsDocData CurrentMyDslComponentsDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslComponentsDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslComponentsDocView CurrentMyDslComponentsDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslComponentsDocView;
			}
		}
		...
		/// </summary>
		protected MyDslComponentsExplorerToolWindow MyDslComponentsExplorerToolWindow
		{
			get
			{
				MyDslComponentsExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslComponentsExplorerToolWindow), true) as MyDslComponentsExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslComponentsExplorerToolWindow explorerWindow = this.MyDslComponentsExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslComponentsClipboardCommandSet : MyDslComponentsClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslComponentsClipboardCommandSet.
		/// </summary>
		public MyDslComponentsClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslComponentsClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslComponentsClipboardCommandSetBase.
		/// </summary>
		protected MyDslComponentsClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
