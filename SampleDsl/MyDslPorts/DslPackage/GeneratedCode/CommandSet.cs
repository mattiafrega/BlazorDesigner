...
namespace Company.MyDslPorts
{
	...
	/// </summary>
	internal partial class MyDslPortsCommandSet : MyDslPortsCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslPortsCommandSet.
		/// </summary>
		public MyDslPortsCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class MyDslPortsCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new MyDslPortsCommandSetBase.
		/// </summary>
		protected MyDslPortsCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewMyDslPortsExplorerCommand,
				typeof(MyDslPortsEditorFactory).GUID);
		...
		{
			MyDslPortsExplorerToolWindow explorer = this.MyDslPortsExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected MyDslPortsDocData CurrentMyDslPortsDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as MyDslPortsDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected MyDslPortsDocView CurrentMyDslPortsDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as MyDslPortsDocView;
			}
		}
		...
		/// </summary>
		protected MyDslPortsExplorerToolWindow MyDslPortsExplorerToolWindow
		{
			get
			{
				MyDslPortsExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(MyDslPortsExplorerToolWindow), true) as MyDslPortsExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				MyDslPortsExplorerToolWindow explorerWindow = this.MyDslPortsExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class MyDslPortsClipboardCommandSet : MyDslPortsClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new MyDslPortsClipboardCommandSet.
		/// </summary>
		public MyDslPortsClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class MyDslPortsClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new MyDslPortsClipboardCommandSetBase.
		/// </summary>
		protected MyDslPortsClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
