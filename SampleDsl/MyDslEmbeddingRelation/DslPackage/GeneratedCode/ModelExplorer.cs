...
namespace Company.MyDslEmbeddingRelation
{
	...
	/// </summary>
	internal partial class MyDslEmbeddingRelationExplorer : MyDslEmbeddingRelationExplorerBase
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationExplorer.
		/// </summary>
		public MyDslEmbeddingRelationExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the MyDslEmbeddingRelationExplorerToolWindow.
	/// </summary>
	internal abstract class MyDslEmbeddingRelationExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationExplorerBase.
		/// </summary>
		protected MyDslEmbeddingRelationExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.MyDslEmbeddingRelationExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.MyDslEmbeddingRelation.ExampleModel.DomainClassId; }
		}
