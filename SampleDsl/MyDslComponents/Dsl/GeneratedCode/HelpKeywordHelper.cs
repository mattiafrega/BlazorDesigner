...
namespace Company.MyDslComponents
{
	...
	/// </remarks>
	public partial class MyDslComponentsHelpKeywordHelper : MyDslComponentsHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslComponentsHelpKeywordHelper.
		/// </summary>
		protected MyDslComponentsHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslComponentsHelpKeywordHelper.
		/// </summary>
		public static MyDslComponentsHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslComponentsHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslComponentsHelpKeywordHelperBase.
		/// </summary>
		protected MyDslComponentsHelpKeywordHelperBase()
			: base() { }
