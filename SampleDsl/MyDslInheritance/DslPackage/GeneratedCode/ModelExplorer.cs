...
namespace Company.MyDslInheritance
{
	...
	/// </summary>
	internal partial class MyDslInheritanceExplorer : MyDslInheritanceExplorerBase
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceExplorer.
		/// </summary>
		public MyDslInheritanceExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the MyDslInheritanceExplorerToolWindow.
	/// </summary>
	internal abstract class MyDslInheritanceExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new MyDslInheritanceExplorerBase.
		/// </summary>
		protected MyDslInheritanceExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.MyDslInheritanceExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.MyDslInheritance.ExampleModel.DomainClassId; }
		}
