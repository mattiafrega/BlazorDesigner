...
namespace Company.MyDSL
{
	...
	/// </remarks>
	public partial class MyDSLHelpKeywordHelper : MyDSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDSLHelpKeywordHelper.
		/// </summary>
		protected MyDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDSLHelpKeywordHelper.
		/// </summary>
		public static MyDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDSLHelpKeywordHelperBase.
		/// </summary>
		protected MyDSLHelpKeywordHelperBase()
			: base() { }
