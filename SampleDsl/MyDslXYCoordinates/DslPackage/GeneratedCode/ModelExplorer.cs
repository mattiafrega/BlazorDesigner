...
namespace Company.MyDslXYCoordinates
{
	...
	/// </summary>
	internal partial class MyDslXYCoordinatesExplorer : MyDslXYCoordinatesExplorerBase
	{
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesExplorer.
		/// </summary>
		public MyDslXYCoordinatesExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the MyDslXYCoordinatesExplorerToolWindow.
	/// </summary>
	internal abstract class MyDslXYCoordinatesExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesExplorerBase.
		/// </summary>
		protected MyDslXYCoordinatesExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.MyDslXYCoordinatesExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.MyDslXYCoordinates.ExampleModel.DomainClassId; }
		}
