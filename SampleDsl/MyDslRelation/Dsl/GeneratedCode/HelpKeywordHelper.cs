...
namespace Company.MyDslRelation
{
	...
	/// </remarks>
	public partial class MyDslRelationHelpKeywordHelper : MyDslRelationHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslRelationHelpKeywordHelper.
		/// </summary>
		protected MyDslRelationHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslRelationHelpKeywordHelper.
		/// </summary>
		public static MyDslRelationHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslRelationHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslRelationHelpKeywordHelperBase.
		/// </summary>
		protected MyDslRelationHelpKeywordHelperBase()
			: base() { }
