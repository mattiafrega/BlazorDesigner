...
namespace Company.MyDslSwimlane
{
	...
	/// </remarks>
	public partial class MyDslSwimlaneToolboxHelper : MyDslSwimlaneToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslSwimlaneToolboxHelper.
		/// </summary>
		public MyDslSwimlaneToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslSwimlaneToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslSwimlane toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslSwimlane.1.0";
		...
		/// <summary>
		/// Constructs a new MyDslSwimlaneToolboxHelperBase.
		/// </summary>
		protected MyDslSwimlaneToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslSwimlane.MyDslSwimlaneDomainModel.SingletonResourceManager.GetString("MyDslSwimlaneToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.MyDslSwimlane.MyDslSwimlaneDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.MyDslSwimlane.MyButtonCompToolboxItem":
					// Add MyButtonComp shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslSwimlane.MyButtonCompToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MyButtonCompToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MyButtonCompToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslSwimlane.MyDslSwimlaneToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslSwimlaneToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"MyButtonComp", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MyButtonCompToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslSwimlane.MyButton.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslSwimlane.MySwimLaneCompToolboxItem":
					// Add MySwimLaneComp shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslSwimlane.MySwimLaneCompToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MySwimLaneCompToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MySwimLaneCompToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.
						"Company.MyDslSwimlane.MyDslSwimlaneToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslSwimlaneToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"MySwimLaneComp", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MySwimLaneCompToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Company.MyDslSwimlane.MySwimLane.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslSwimlane.MyDslSwimlaneDomainModel));
