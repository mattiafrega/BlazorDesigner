...
namespace Company.MyDslRelation
{
	...
	/// </remarks>
	public partial class MyDslRelationToolboxHelper : MyDslRelationToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslRelationToolboxHelper.
		/// </summary>
		public MyDslRelationToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslRelationToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslRelation toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslRelation.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify MyConnector connector tool.
		/// </summary>
		public const string MyConnectorFilterString = "MyConnector.1.0";
		...
		/// <summary>
		/// Constructs a new MyDslRelationToolboxHelperBase.
		/// </summary>
		protected MyDslRelationToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslRelation.MyDslRelationDomainModel.SingletonResourceManager.GetString("MyDslRelationToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.MyDslRelation.MyDslRelationDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.MyDslRelation.MyButtonToolboxItem":
					// Add MyButton shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslRelation.MyButtonToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.MyDslRelation.MyDslRelationToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslRelationToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.MyDslRelation.MyButton.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.MyDslRelation.MyConnectorToolboxItem":

					// Add MyConnector connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslRelation.MyConnectorToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("MyConnectorToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("MyConnectorToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Company.MyDslRelation.MyDslRelationToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslRelationToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ConnectExampleRelationF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("MyConnectorToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(MyConnectorFilterString)
						});
					break;
				default:
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslRelation.MyDslRelationDomainModel));
