...
namespace Company.MyDslXYCoordinates
{
	...
	/// </remarks>
	public partial class MyDslXYCoordinatesToolboxHelper : MyDslXYCoordinatesToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesToolboxHelper.
		/// </summary>
		public MyDslXYCoordinatesToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class MyDslXYCoordinatesToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify MyDslXYCoordinates toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "MyDslXYCoordinates.1.0";
		...
		/// <summary>
		/// Constructs a new MyDslXYCoordinatesToolboxHelperBase.
		/// </summary>
		protected MyDslXYCoordinatesToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDslXYCoordinates.MyDslXYCoordinatesDomainModel.SingletonResourceManager.GetString("MyDslXYCoordinatesToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.MyDslXYCoordinates.MyDslXYCoordinatesDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.MyDslXYCoordinates.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.MyDslXYCoordinates.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.MyDslXYCoordinates.MyDslXYCoordinatesToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("MyDslXYCoordinatesToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.MyDslXYCoordinates.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.MyDslXYCoordinates.MyDslXYCoordinatesDomainModel));
