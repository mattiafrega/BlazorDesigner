...
namespace Company.MyDslCompartment
{
	...
	/// </remarks>
	public partial class MyDslCompartmentHelpKeywordHelper : MyDslCompartmentHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslCompartmentHelpKeywordHelper.
		/// </summary>
		protected MyDslCompartmentHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslCompartmentHelpKeywordHelper.
		/// </summary>
		public static MyDslCompartmentHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslCompartmentHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslCompartmentHelpKeywordHelperBase.
		/// </summary>
		protected MyDslCompartmentHelpKeywordHelperBase()
			: base() { }
