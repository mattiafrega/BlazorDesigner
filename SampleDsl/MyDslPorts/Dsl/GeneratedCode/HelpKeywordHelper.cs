...
namespace Company.MyDslPorts
{
	...
	/// </remarks>
	public partial class MyDslPortsHelpKeywordHelper : MyDslPortsHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new MyDslPortsHelpKeywordHelper.
		/// </summary>
		protected MyDslPortsHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the MyDslPortsHelpKeywordHelper.
		/// </summary>
		public static MyDslPortsHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class MyDslPortsHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new MyDslPortsHelpKeywordHelperBase.
		/// </summary>
		protected MyDslPortsHelpKeywordHelperBase()
			: base() { }
