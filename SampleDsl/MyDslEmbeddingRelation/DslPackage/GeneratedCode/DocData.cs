...
namespace Company.MyDslEmbeddingRelation
{
	...
	/// </summary>
	internal partial class MyDslEmbeddingRelationDocData : MyDslEmbeddingRelationDocDataBase
	{
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationDocData.
		/// </summary>
		public MyDslEmbeddingRelationDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a MyDslEmbeddingRelation document in memory.
	/// </summary>
	internal abstract partial class MyDslEmbeddingRelationDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new MyDslEmbeddingRelationDocDataBase.
		/// </summary>
		protected MyDslEmbeddingRelationDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Company.MyDslEmbeddingRelation.ExampleModel modelRoot = null;
			...
			global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Company.MyDslEmbeddingRelation.ExampleModel modelRoot = (global::Company.MyDslEmbeddingRelation.ExampleModel)this.RootElement;
			...
			{
				global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDiagram diagram = diagrams[0] as global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Company.MyDslEmbeddingRelation.ExampleModel modelRoot = this.RootElement as global::Company.MyDslEmbeddingRelation.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Company.MyDslEmbeddingRelation.MyDslEmbeddingRelationSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
