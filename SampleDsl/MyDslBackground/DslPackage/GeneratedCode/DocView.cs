...
namespace Company.MyDSL
{
	...
	/// </summary>
	internal partial class MyDSLDocView : MyDSLDocViewBase
	{
		/// <summary>
		/// Constructs a new MyDSLDocView.
		/// </summary>
		public MyDSLDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class MyDSLDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new MyDSLDocView.
		/// </summary>
		protected MyDSLDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			MyDSLDocDataBase docData = this.DocData as MyDSLDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for MyDSLDocViewBase should be an MyDSLDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.MyDSL.MyDSLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.MyDSL.MyDSLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.MyDSL.MyDSLToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.MyDSL.MyDSLToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.MyDSLDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.MyDSL.MyDSLHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.MyDSL.MyDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.MyDSL.MyDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
