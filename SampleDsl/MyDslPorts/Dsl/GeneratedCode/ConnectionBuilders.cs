...
namespace Company.MyDslPorts
{
	...
	public static partial class ConnectionBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.MyDslPorts.OutPort)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Company.MyDslPorts.InPort)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.MyDslPorts.OutPort)
				{
					if (candidateTarget is global::Company.MyDslPorts.InPort)
					{
						global::Company.MyDslPorts.OutPort sourceOutPort = (global::Company.MyDslPorts.OutPort)candidateSource;
						global::Company.MyDslPorts.InPort targetInPort = (global::Company.MyDslPorts.InPort)candidateTarget;
						if(targetInPort == null || sourceOutPort == null || global::Company.MyDslPorts.Connection.GetLinks(sourceOutPort, targetInPort).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.MyDslPorts.OutPort)
				{
					if (target is global::Company.MyDslPorts.InPort)
					{
						global::Company.MyDslPorts.OutPort sourceAccepted = (global::Company.MyDslPorts.OutPort)source;
						global::Company.MyDslPorts.InPort targetAccepted = (global::Company.MyDslPorts.InPort)target;
						DslModeling::ElementLink result = new global::Company.MyDslPorts.Connection(sourceAccepted, targetAccepted);
